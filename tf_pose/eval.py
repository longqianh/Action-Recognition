...
#         description='Tensorflow Openpose Inference')
...
#     coco_json_file = args.coco_dir + \
#         'annotations/person_keypoints_val%s.json' % args.cocoyear
...
#     write_json = '../etcs/%s_%s_%0.1f.json' % (
...
#         tqdm_keys.set_postfix(OrderedDict(
#             {'inference time': elapsed, 'score': avg_score}))
#         if args.data_idx >= 0:
