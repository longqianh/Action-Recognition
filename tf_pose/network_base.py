...
_init_xavier = tf.compat.v1.keras.initializers.VarianceScaling(
...
_l2_regularizer_convb = tf.keras.regularizers.l2(
    0.5 * (common.regularizer_conv))
...
class BaseNetwork(object):
    ...
    def se_block(self, input_feature, name, ratio=8):
        ...
        with tf.compat.v1.variable_scope(name):
            ...
            squeeze = tf.reduce_mean(input_tensor=input_feature, axis=[
                                     1, 2], keepdims=True)
